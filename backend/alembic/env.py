...
from app.modules.templates.model import DocumentTemplate, HtmlTemplate, TemplateField, AIConfiguration, ExcelUploadSession, CustomerHeaderMapping, StandardizedDataset, ValidationLog, PromptTemplate, ReportVersion, ReportAudit, ReportGeneration, AIProcessingLog, LearningHistory
